module.exports = function (grunt) {
  ...
  grunt.addCmd('cp_build', function(rev) {
    ...
    return 'rm -rf ' + r_dir + ' && ' +
        ...
        'cp -aL dart/standalone/dart/out/ReleaseX64/packages ' + r_dir + ' && ' +
        'cp -aL dart/standalone/dart/sdk ' + r_dir;
  });

  grunt.addCmd('ln_build', function(rev) {
    rev = rev || 'head';
    var r_dir = 'dart_versions/' + rev;
    return 'rm -f dart_versions/current && ' +
        'ln -s ' + rev + ' dart_versions/current && ' +
        'echo "' + rev + '" > dart_versions/CURRENT_VERSION && ' +
        'echo "1.0.0.0_r99999" >dart_versions/version';
  });
